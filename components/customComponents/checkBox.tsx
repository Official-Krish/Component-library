            ...
            <div className="flex items-center justify-center h-full">
                <div>
                    {todos.map((todo) => (
                        <motion.button
                            key={todo.id}
                            className="flex items-center text-neutral-800 mb-2 hover:bg-neutral-300 rounded-lg px-4 py-2 transition-colors duration-200 cursor-pointer"  
                        ...
                        >
                            ...
                            <motion.p 
                                className="text-lg font-medium relative overflow-hidden"
                                initial={false}
                                animate={{
                            ...
                            >
                                ...
                                <motion.span
                                    ...
                                    initial={{ x: todo.checked ? "0%" : "-100%" }}
                                    animate={{ x: todo.checked ? "0%" : "-100%" }}
                                    transition={{
                                        ...baseT,
                                        delay: todo.checked ? baseDelay : 0,
                                    }}
...
function SVG({ Todo }: { Todo: Todo} ) {
    return (
      ...
      >
        ...
        <motion.path
            initial= {{
                clipPath: Todo.checked ? "inset(0% 0% 0% 0%)" : "inset(0% 100% 0% 0%)",
            }}
            animate= {{
                clipPath: Todo.checked ? "inset(0% 0% 0% 0%)" : "inset(0% 100% 0% 0%)",
                transition: {
        ...
        <motion.path
          ...
          animate= {{
            ...
            transition: {
                ...baseT,
                delay: Todo.checked ? 0 : baseDelay,
            }
          }}
