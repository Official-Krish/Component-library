      ...
      <div className="w-full space-y-4">
            ...
            <div className="relative">
              <div className="inline-flex overflow-hidden rounded-md border border-border text-xs">
                {packageManagers.map((pm, index) => (
                  <div key={pm} className="flex items-center bg-[#1C2433]">
                    {index > 0 && (
        ...
        <div className="relative flex">
          ...
          <Button
            variant="outline"
            size="icon"
            className="relative ml-2 rounded-md text-neutral-700 cursor-pointer hover:bg-neutral-100 focus-visible:ring-2 focus-visible:ring-neutral-500 focus-visible:ring-offset-2"
            onClick={copyToClipboard}
            aria-label={copied ? "Copied" : "Copy to clipboard"}
          >
            <span className="sr-only text-neutral-700">{copied ? "Copied" : "Copy"}</span>
            <Copy
            ...
            />
            <Check
              className={`absolute inset-0 m-auto h-4 w-4 transition-all duration-300 text-neutral-700 ${
